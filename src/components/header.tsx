...
export default function Header() {
   return (
      <header className="max-w-full flex flex-col md:flex-row md:items-center justify-between">
         <div className="flex items-center gap-4 md:gap-8">
            <div className="relative size-32 md:size-60 rounded-full overflow-hidden">
               <Image 
                  src={Coffee} fill 
                  alt="company logo" 
            ...
            <div>
               <h1 className="text-xl sm:text-2xl md:text-3xl font-medium">Coffee Store</h1>
               <p className="md:text-lg text-muted-foreground -mt-1">Odessa, ON</p>

               <div className="flex items-center gap-4 mt-2 sm:mt-3 text-muted-foreground">
                  <div className="hidden lg:flex items-center gap-2 [&_svg]:size-4 [&_svg]:shrink-0">
         ...
         <div className="flex flex-col items-center">
            <div className="relative hidden md:block size-15 md:size-32 rounded-full overflow-hidden border border-border/30">
               <Image 
                  src={OwnerImage} fill 
            ...
            <p className="text-sm md:text-base text-muted-foreground mt-4 md:mt-2">Owned by Lola and Coco</p>
         </div>
      </header>
   )
}
